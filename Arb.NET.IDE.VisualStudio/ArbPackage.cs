...
namespace Arb.NET.IDE.VisualStudio {
    ...
    [Guid(ArbPackage.PackageGuidString)]
    [ProvideToolWindow(typeof(ArbToolWindow))]
    public sealed class ArbPackage : AsyncPackage {
        /// <summary>
        /// Arb.NET.IDE.VisualStudioPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "3191a384-5cf6-4e40-bd0f-3a6dcd5dc05f";
